...
//        }
    ...
    public function loginAction() {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            $password = $request->getPost('userpass');
            $authAdapter = new AuthAdapter($dbAdapter, 'tbl_admin_login', 'username', 'password', 'md5(?)');
            ...
            switch ($result->getCode()) {
                ...
                case Result::SUCCESS:
                   ...
                   // Debug::dump($storage->read());
                    //exit;
                    $userSession = new Container('admin');
                    $userSession->adminId = $storage->read()->id;

...
use ZfcAdmin\Form\EducationfieldForm;
use ZfcAdmin\Form\EducationlevelForm;
use ZfcAdmin\Form\ProfessionForm;
use ZfcAdmin\Form\DesignationForm;
use ZfcAdmin\Form\UsertypeForm;
use ZfcAdmin\Form\EducationfieldFilter;
use ZfcAdmin\Form\EducationlevelFilter;
use ZfcAdmin\Form\ProfessionFilter;
use ZfcAdmin\Form\DesignationFilter;
use ZfcAdmin\Form\UsertypeFilter;
...
class MasterController extends AppController
{
    public function masterviewAction()
    {
        ...
        foreach ($masterarray1 as $key => $value) {
            ...
            // $url = $this->url("zfcadmin/admin",array("controller"=>$key,"action"=>"index"));
